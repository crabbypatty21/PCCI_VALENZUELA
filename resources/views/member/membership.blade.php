...
<div id="section-membership" class="content-section" style="display: none;">
    ...
    <div class="pricing-cards">
        <div class="pricing-card">
            <h2 id="membershipPlanPrimaryName">Loading plan...</h2>
            <ul>
            ...
            <div class="pricing-price" id="membershipPlanPrimaryPrice">Loading...</div>
        </div>

        <div class="pricing-card">
            <h2 id="membershipPlanSecondaryName">Loading plan...</h2>
            <ul>
            ...
            <div class="pricing-price red" id="membershipPlanSecondaryPrice">Loading...</div>
        </div>
    </div>
</div>